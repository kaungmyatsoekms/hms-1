...
class HMSHousekeepingActivities(models.Model):
    _name = "hms.housekeeping.activities"
    _description = "Housekeeping Activities "

    a_list = fields.Many2one('hms.housekeeping', string='Reservation')
    today_date = fields.Date('Today Date')
    activity_name = fields.Many2one('hms.activity',
