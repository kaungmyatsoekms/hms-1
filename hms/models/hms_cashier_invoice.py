...
class HMSCashierFolio(models.Model):
    ...
    refund_invoice_id = fields.Many2one('hms.cashier.folio', string="Invoice for which this invoice is the credit note")
    ...
    vendor_bill_id = fields.Many2one('hms.cashier.folio', string='Vendor Bill',
    ...
    invoice_line_ids = fields.One2many('hms.cashier.folio.line', 'invoice_id', string='Invoice Lines', oldname='invoice_line',
        readonly=True, states={'draft': [('readonly', False)]}, copy=True)
    tax_line_ids = fields.One2many('account.invoice.tax', 'invoice_id', string='Tax Lines', oldname='tax_line',
        readonly=True, states={'draft': [('readonly', False)]}, copy=True)
    refund_invoice_ids = fields.One2many('hms.cashier.folio', 'refund_invoice_id', string='Refund Invoices', readonly=True)
    ...
    company_id = fields.Many2one('res.company', string='Company', change_default=True,
        required=True, readonly=True, states={'draft': [('readonly', False)]},
        default=lambda self: self.env['res.company']._company_default_get('hms.cashier.folio'))
    ...
    def create(self, vals):
        ...
        invoice = super(HMSCashierFolio, self.with_context(mail_create_nolog=True)).create(vals)
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        supplier_form_view_id = get_view_id('invoice_supplier_form', 'hms.cashier.folio.supplier.form').id
        if context.get('active_model') == 'res.partner' and context.get('active_ids'):
            ...
            if not view_type:
                ...
                if partner.supplier and not partner.customer:
                    ...
                    view_id = get_view_id('invoice_form', 'hms.cashier.folio.form').id

        return super(hms.cashier.folio, self).fields_view_get(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
    ...
    def message_post(self, **kwargs):
        ...
        return super(HMSCashierFolio, self.with_context(mail_post_autofollow=True)).message_post(**kwargs)
    ...
    def message_new(self, msg_dict, custom_values=None):
        ...
        invoice = super(HMSCashierFolio, self.with_context(type=values.get('type'))).message_new(msg_dict, values)
    ...
    def _notify_get_groups(self, message, groups):
        ...
        groups = super(HMSCashierFolio, self)._notify_get_groups(message, groups)
...
class HMSCashierFolioLine(models.Model):
    ...
    @api.model
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        res = super(HMSCashierFolioLine, self).fields_view_get(
