...
class RateCodeDetails(models.Model):
    ...
    special_price2 = fields.Float(string="+2 Adult", digits='Rate Price')
    special_price3 = fields.Float(string="+3 Adult", digits='Rate Price')
    special_price4 = fields.Float(string="+4 Adult", digits='Rate Price')
    special_extra = fields.Float(string="Extra", digits='Rate Price')
    extra_bed = fields.Float(string="Extra Bed", digits='Rate Price')
