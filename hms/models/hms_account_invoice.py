...
class AccountInvoice(models.Model):
    ...
    vendor_bill_id = fields.Many2one('account.invoice',
                                     string='Vendor Bill',
    ...
    invoice_line_ids = fields.One2many('account.invoice.line',
                                       ...
                                       readonly=True,
                                       states={'draft': [('readonly', False)]},
                                       copy=True, domain=[('folio_id','=', 1)])
    invoice2_line_ids = fields.One2many('account.invoice.line',
                                       'invoice_id',
                                       string='Invoice Lines',
                                       oldname='invoice_line',
                                       readonly=True,
                                       states={'draft': [('readonly', False)]},
                                       copy=True, domain=[('folio_id','=', 2)])
    ...
    def fields_view_get(self,
        ...
        supplier_form_view_id = get_view_id('invoice_supplier_form',
            ...
            if not view_type:
                ...
                if partner.supplier and not partner.customer:
                    ...
                    view_id = get_view_id('invoice_form',
                                          'account.invoice.form').id

        return super(AccountInvoice, self).fields_view_get(view_id=view_id,
                                                           view_type=view_type,
                                                           toolbar=toolbar,
                                                           submenu=submenu)
