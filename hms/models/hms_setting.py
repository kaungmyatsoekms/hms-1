...
class ProductProduct(models.Model):
    ...
    def _convert_prepared_anglosaxon_line(self, line, partner):
        return {
            ...
            'amount_currency':
            line['price'] > 0 and abs(line.get('amount_currency', False))
            ...
            'product_uom_id':
            line.get('uom_id', False),
            'analytic_account_id':
            line.get('account_analytic_id', False),
            'invoice_id':
            line.get('invoice_id', False),
            'tax_ids':
            line.get('tax_ids', False),
            'tax_line_id':
            line.get('tax_line_id', False),
            'analytic_tag_ids':
            line.get('analytic_tag_ids', False),
        }
